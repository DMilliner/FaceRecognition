...
**
** Created: Wed May 29 09:46:32 2013
...
static const char qt_meta_stringdata_detection[] = {
    "detection\0"
};
...
const QMetaObjectExtraData detection::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject detection::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_detection,
      qt_meta_data_detection, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &detection::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_detection))
