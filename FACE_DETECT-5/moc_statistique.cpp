...
**
** Created: Wed May 29 09:46:33 2013
...
static const char qt_meta_stringdata_statistique[] = {
    "statistique\0"
};
...
const QMetaObjectExtraData statistique::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject statistique::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_statistique,
      qt_meta_data_statistique, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &statistique::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_statistique))
        return static_cast<void*>(const_cast< statistique*>(this));
